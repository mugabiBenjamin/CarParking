...
public final class PlateInputPanel extends JPanel {
    ...
    public PlateInputPanel(
        ...
        if (submitHandler == null) {
            throw new IllegalArgumentException("Plate submit handler cannot be null");
        }
        ...
        initializeComponents(buttonText, buttonIcon, buttonTooltip);
    }
    ...
    private void initializeComponents(String buttonText, Icon buttonIcon, String buttonTooltip) {
        ...
        add(plateInput);
        add(validationIcon);
        add(HoverButtonFactory.createButton(
                buttonText,
                buttonIcon,
                buttonTooltip,
                this::submit
    ...
    private boolean isPlaceholderVisible() {
        return PLACEHOLDER_TEXT.equals(plateInput.getText())
                && PLACEHOLDER_COLOR.equals(plateInput.getForeground());
    }
